...
function CalendarSection({ user }) {
    ...
    return (
        ...
        <section className='w-full md:w-1/2 p-2 bg-gray-100 rounded-xl shadow-sm justify-center items-center'>
            ...
            <h3 className='text-md text-center pt-2'> Alalluna es un prototipo de academia </h3>
        </section>
    )
}
